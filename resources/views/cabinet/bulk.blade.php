    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-header"><h3>Массовая отправка</h3></div>
                <div class="card-body">
...
{{--                        </div>--}}
                        ...
                        @if(Auth::user()->checkUpSendSms())
                            ...
                            <button class="btn btn-light" type="button" id="btn-coast">Подсчитать стоимость рассылки</button>
                        @endif
                    </form>
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div id="error_response" class="alert-danger" style="display: none">
                    </div>
                    <table class="table table-bordered" style="display: none" id="table_response">
                        <thead>
                        <tr>
                            <th>Номеров в базе</th>
                            <th>Кол-во частей в смс</th>
                        ...
                        <tbody>
                        <tr>
                            <td id="number_response" style="font-weight: bold"></td>
                            <td id="count_response" style="font-weight: bold"></td>
                            <td id="coats_response" style="font-weight: bold"></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
